...
VGG_Weights_path = "/Users/xiaoyuanguo/Downloads/image-segmentation-keras-master/data/vgg16_weights_th_dim_ordering_th_kernels.h5"
...
def FCN8( nClasses=2,  input_height=256, input_width=256 , vgg_level=3):
...
#	print img_input
	...
	o = (Conv2D( nClasses, kernel_size=(9,9), strides=(1,1), use_bias=False, data_format=IMAGE_ORDERING))(o)
