...
class Ref:
    ...
    def get_he_ref():
        ...
        img_file = "/DP_Share/imageviewer/algorithms/python3/color_deconv_utils/he_ref.png"
    ...
    def get_ihc_ref():
        ...
        img_file = "/DP_Share/imageviewer/algorithms/python3/color_deconv_utils/ihc_ref.png"
        ref_img = read_im(img_file)
        HERef, maxCRef = custom_ref(ref_img)
