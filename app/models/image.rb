class Image < ActiveRecord::Base
  ...
  def whole_image_path
    ...
    file_base = File.basename(self.file_file_name, File.extname(self.file_file_name))
    first_try = File.join('public', self.file_folder_url, file_base + '_3d_view', '0_0.jpeg')
    second_try = File.join(self.file_folder_url, file_base + '_3d_view', '0_0.png')



    if File.file?(first_try) 
      return File.join(self.file_folder_url, file_base + '_3d_view', '0_0.jpeg')
    else
      return second_try
    end
  end
